...
@FacesConverter(value = "catalogoDocumentoConverter")
public class CatalogoDocumentoConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof CatalogoDocumento) {
            CatalogoDocumento o = (CatalogoDocumento) object;
            return getStringKey(o.getIdCatalogoDocumento());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), CatalogoDocumento.class.getName()});
            return null;
        }
    }
}
