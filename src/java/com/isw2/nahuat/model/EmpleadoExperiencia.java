...
@NamedQueries({
    ...
    @NamedQuery(name = "EmpleadoExperiencia.findByIdEmpeladoExperiencia", query = "SELECT e FROM EmpleadoExperiencia e WHERE e.idEmpeladoExperiencia = :idEmpeladoExperiencia"),
...
public class EmpleadoExperiencia implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 5)
    @Column(name = "ID_EMPELADO_EXPERIENCIA")
    private String idEmpeladoExperiencia;
    @Basic(optional = false)
    @NotNull
    @Column(name = "SALARIO")
    ...
    public EmpleadoExperiencia(String idEmpeladoExperiencia) {
        this.idEmpeladoExperiencia = idEmpeladoExperiencia;
    }

    public EmpleadoExperiencia(String idEmpeladoExperiencia, BigInteger salario, String empresa, Date fechaInicio, Date fechaFin) {
        this.idEmpeladoExperiencia = idEmpeladoExperiencia;
    ...
    public String getIdEmpeladoExperiencia() {
        return idEmpeladoExperiencia;
    }

    public void setIdEmpeladoExperiencia(String idEmpeladoExperiencia) {
        this.idEmpeladoExperiencia = idEmpeladoExperiencia;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (idEmpeladoExperiencia != null ? idEmpeladoExperiencia.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.idEmpeladoExperiencia == null && other.idEmpeladoExperiencia != null) || (this.idEmpeladoExperiencia != null && !this.idEmpeladoExperiencia.equals(other.idEmpeladoExperiencia))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.isw2.nahuat.model.EmpleadoExperiencia[ idEmpeladoExperiencia=" + idEmpeladoExperiencia + " ]";
    }
