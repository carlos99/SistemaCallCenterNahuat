...
@NamedQueries({
    ...
    @NamedQuery(name = "EmpresaConfiguracion.findByPorcentajeHoraExtra", query = "SELECT e FROM EmpresaConfiguracion e WHERE e.porcentajeHoraExtra = :porcentajeHoraExtra"),
    @NamedQuery(name = "EmpresaConfiguracion.findByPorcentajeLlegadaTarde", query = "SELECT e FROM EmpresaConfiguracion e WHERE e.porcentajeLlegadaTarde = :porcentajeLlegadaTarde")})
public class EmpresaConfiguracion implements Serializable {
    ...
    @Column(name = "PORCENTAJE_HORA_EXTRA")
    private BigInteger porcentajeHoraExtra;
    @Column(name = "PORCENTAJE_LLEGADA_TARDE")
    private BigInteger porcentajeLlegadaTarde;
    @JoinColumn(name = "ID_EMPRESA", referencedColumnName = "ID_EMPRESA")
    @ManyToOne(optional = false)
    private Empresa idEmpresa;
    @JoinColumn(name = "ID_CATALOGO_UBICACION", referencedColumnName = "ID_CATALOGO_UBICACION")
    @ManyToOne(optional = false)
    ...
    public BigInteger getPorcentajeHoraExtra() {
        return porcentajeHoraExtra;
    }

    public void setPorcentajeHoraExtra(BigInteger porcentajeHoraExtra) {
        this.porcentajeHoraExtra = porcentajeHoraExtra;
    }

    public BigInteger getPorcentajeLlegadaTarde() {
        return porcentajeLlegadaTarde;
    }

    public void setPorcentajeLlegadaTarde(BigInteger porcentajeLlegadaTarde) {
        this.porcentajeLlegadaTarde = porcentajeLlegadaTarde;
    }
